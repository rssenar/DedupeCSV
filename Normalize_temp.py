...
def main():
	...
	if STATEList != '':
		...
		for item in STATEList:
			item = item.strip()
			SuppressSTATEList.append(item)
	print('SuppressSTATEList = ',SuppressSTATEList)
	...
	if SCFList != '':
		...
		for item in SCFList:
			item = item.strip()
			SuppressSCFList.append(item)
	print('SuppressSCFList = ',SuppressSCFList)
	...
	if YEARList != '':
		...
		for item in YEARList:
			item = item.strip()
			SuppressYEARList.append(item)
	print('SuppressYEARList = ',SuppressYEARList)
	...
	if CITYList != '':
		...
		for item in CITYList:
			item = item.strip()
			SuppressCITYList.append(item)
	print('SuppressCITYList = ',SuppressCITYList)
	...
	# ======================================================================== #
	print('')
	NormSelect = raw_input('...... Normalizing File [Press ENTER] : ')
	print('')
	# ==================================================================== #
	# MAIN Function
	# ==================================================================== #
	...
	open(AppendMonthlySuppFile,'ab') as AppendMonthlySupp:
		...
		for line in tqdm(Input):
			if FirstLineMain:
				FirstLineMain = False # Skip Header Row
			else:
				# ============================================================ #
				...
				str(line[State]) in SuppressSTATEList or \
				str(line[SCF]) in SuppressSCFList or \
				str(line[Year]) in SuppressYEARList or \
				str(line[City]) in SuppressCITYList:
					line[MailDNQ] = 'dnq'
				# ============================================================ #
				# Generate COUNTERS
				# ============================================================ #
...
if __name__ == '__main__':
	...
	try:
		...
		print('............. T O T A L ............. : {}'.format(DatabaseCounter + \
			PurchaseCounter + PennyCounter + NickelCounter - \
			MDNQCounter - DupesCounter))
		UpkeepSelect = raw_input('..... Delete Temp Files [Press ENTER] : ')
		Upkeep() # Call Upkeep Function
		print('============= COMPLETED! ==============')
		print('')
	except:
		print('ERROR! Mismatched Headers! - Please Re-Map Headers!')
